...
public class PDF {
	...
	public void generate(String empid) throws SQLException, IOException{ //empid not implemented yet, should be able to get everything you will need from it
		...
		contentStream.showText( "Training Report: John Doe          " ); //NAME
                contentStream.showText("Emp ID: 123456789");
		contentStream.newLine();
		contentStream.showText("Induction: 123 Java ");//Stream Code + Stream Name
		contentStream.newLine();
                contentStream.showText("Foundation: ");
                contentStream.newLine();
                ...
                contentStream.showText("Foundation Grade: ");
                contentStream.showText("Specialization Grade: ");
                contentStream.showText("Process/Domain Grade: ");
