...
-- -----------------------------------------------------
CREATE USER Student_Performance IDENTIFIED BY Student_Performance /* DEFAULT CHARACTER SET utf8 */ ;
ALTER SESSION SET CURRENT_SCHEMA = Student_Performance ;
...
CREATE TABLE Student_Performance.Employees_take_Modules (
  ...
  employee_id VARCHAR2(30) NOT NULL
 ,
  CONSTRAINT fk_Modules_has_Students_Modules1
    FOREIGN KEY (module_id)
    REFERENCES Student_Performance.Modules (module_id)
   ,
  CONSTRAINT fk_Modules_has_Students_Students1
